...
public interface ValidationConstants {
    ...
    String MAX_UPLOAD_SIZE_EXCEEDED = "UUID string too large";
    ...
    String USER_NAME_HAS_TO_BE_PRESENT = "USERNAME HAS TO BE PRESENT";
    String UNKNOWN = "UNKNOWN";
    String USER_ROLE_NOT_NULL = "user role mustn't be null";
    String  USER_NOT_FOUND = "Could not find user";
    String UNAUTHORIZED = "JWT signature does not match locally computed signature. JWT validity cannot be asserted and should not be trusted.";
