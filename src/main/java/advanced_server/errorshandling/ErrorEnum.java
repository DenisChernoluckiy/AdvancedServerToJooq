...
public enum ErrorEnum {
    ...
    UNAUTHORISED(7, ValidationConstants.UNAUTHORIZED),
    ...
    NEWS_IMAGE_LENGTH(45, ValidationConstants.NEWS_IMAGE_LENGTH),
    NEWS_IMAGE_HAS_TO_BE_PRESENT(48, ValidationConstants.NEWS_IMAGE_HAS_TO_BE_PRESENT),
