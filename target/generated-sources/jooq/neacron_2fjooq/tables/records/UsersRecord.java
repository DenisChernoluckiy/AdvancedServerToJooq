...
public class UsersRecord extends UpdatableRecordImpl<UsersRecord> implements Record6<UUID, String, String, String, String, String> {
     ...
     */
    public UsersRecord(UUID id, String avatar, String email, String name, String password, String role) {
        super(Users.USERS);
     ...
     * Create a detached, initialised UsersRecord
     */
    public UsersRecord(neacron_2fjooq.tables.pojos.Users value) {
        super(Users.USERS);
